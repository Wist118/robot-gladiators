...
var startGame = function() {
    ...
    for(var i = 0; i < enemyNames.length; i++) {
        if(playerHealth > 0) {
            ...
            //if player is still alive andif we're not at the last enemy in the array
...
var shop = function() {
    ...
    var shopOptionPrompt = window.prompt(
        "Would you like to REFILL your helth, UPGRADE your attack, or LEAVE the store? Please enter one: 'REFILL', 'UPGRADE', or 'LEAVE' to make a choice."
    );
